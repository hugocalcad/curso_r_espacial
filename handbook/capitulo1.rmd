...
**R**, también conocido como “GNU S”, es un entorno y un lenguaje para el analisis estadístico y la generación de gráficos. R es un lenguage derivado del programa S, desarrollado en los Laboratorios Bell por John Chambers et al. <!-- Inserta la referencia completa, usa bibtex y el paquete citr -->
...
**Windows:** se puede obtener un ejecutable desde  [http://cran.es.r-project.org/bin/windows/base](http://cran.es.r-project.org/bin/windows/base) por ejemplo la versión de 64 bits [R-3.6.1-win.exe](http://cran.es.r-project.org/bin/windows/base/R-3.6.1-win.exe).
